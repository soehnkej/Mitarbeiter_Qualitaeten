sap.ui.define([
	...
	return BaseObject.extend("com.sap.build.zeitconsulting.prototypePlaceholderName.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias com.sap.build.zeitconsulting.prototypePlaceholderName.model.ListSelector
		 */
		 ...
		 * @return {com.sap.build.zeitconsulting.prototypePlaceholderName.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
